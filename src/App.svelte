<script>
  ...
  $: if (redWon) winningText = "Red is the Winner!";
  $: if (blueWon) winningText = "Blue is the Winner!";
...
{:else}
  <div class="row mt-3">
    <div class="col">
      {#if blueWon}
        <h2 class="text-center text-primary">Blue is winner!</h2>
      {:else}
        <h2 class="text-center text-danger">Red is winner!</h2>
      {/if}
    </div>
  </div>
  <div class="row mt-3">
